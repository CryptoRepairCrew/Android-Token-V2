Copyright (c) 2013-2014 AndroidsTokensv2 Developers 0.1.0 BETA
...
Intro
-----
AndroidsTokensv2 is  a free open source project derived from Novacoin, with
the goal of providing a long-term energy-efficient scrypt-based crypto-currency.
Built on the foundation of Bitcoin and PPCoin, innovations such as proof-of-stake
help further advance the field of crypto-currency.

Moreover, modifications to the AndroidsTokensv2 protocol will support all new
...
Visit https://AndroidsTokensv2.org for more info.
